...
const SIGNALS: { title: string; icon: "plus" | "minus" | "ban"; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Тот же снимок нашёлся в другом независимом источнике, который называет вуз",
  ...
  },
  {
    ...
    items: [
      ...
      "Тот же снимок используется другим университетом",
  ...
  },
  {
    ...
    items: [
      ...
      "Стоковый сайт или стоковое фото",
