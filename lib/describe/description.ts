...
/**
 * P2 · issue #20 · Claude with the sources as document blocks (citations enabled) → 3–5 RU sentences
...
export const describeCampus: DescribeCampus = async () => notImplemented("describeCampus", "P2", 20);
